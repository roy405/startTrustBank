...
<form action="StandingOrder" method="POST">
  <div class="form-group">
    
        <label><strong>Payment Type:</strong><input name="paymentType" type="text" placeholder="xxxxxxxx"></label>
     	<br>
     	<br>
     	<label><strong>Payment Date</strong><input name= "paymentDate" type="text" placeholder="xxxxxxxxxxxx"></label>
     	<br>
     	<br>
     	<label><strong>Amount:</strong><input name= "stdamount" type="text" placeholder="xxxxxxxxxxxx" required></label>
     	<br>
     	<br>
