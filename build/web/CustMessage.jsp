...
<body>
	...
	<div class="container">
			<div class="jumbotron">
					<h3>Messages</h3>
					<hr>
<form method="POST" action="MessageCustomer">
                
                <label><strong>E-mail</strong><input  name="email" type="email" placeholder="E-mail"></label>
                <br>
                <br>
                <label><strong>Select Receiver:</strong></label>
                <select name=receiver>
                <option value="Admin">Administrator</option>
                <option value="Manager">Card Center Manager</option>
                </select>
                <br>
                <br>
                <label><strong>Subject</strong><input  name="msubject" type="text" placeholder="Subject"></label>
                <br>
                <br>
                <label><strong>Message:</strong></label><textarea name="message" type="text" placeholder="Messages"></textarea>
                <button type="Send" class="btn btn-success btn-lg">Send</button>
                <br>
                <br>
