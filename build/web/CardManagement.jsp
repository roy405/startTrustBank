           ...
           <c:forEach var="card" items="${ListCard}">  
                <div class="article">
                    <table border="1" width='60%'>
                        <tr>
                    <td><label><c:out value="${card.cardID}" /></label></td>
                    <td> <label><c:out value="${card.cardType}" /></label></td>
                   <td> <label><c:out value="${card.cardNumber}" /></label></td>
                   <td> <label><c:out value="${card.cardHolderNIC}" /></label></td>
                   <td><label><c:out value="${card.cardStatus}" /></label></td>
                    <td><label><c:out value="${card.expiryDate}" /></label></td>
                   <td> <label><c:out value="${card.amountDue}" /></label>  </td>  
                   <td> <label><c:out value="${card.clientFname}" /></label></td>
                   <td> <label><c:out value="${card.ccmID}" /></label></td> </tr>
